...
module.exports = class Pane extends DisplayElement {
  ...
  drawFrame(writable, debug=false) {
    ...
    // Corners
    writable.write(ansi.moveCursor(this.top, left))
    writable.write(unic.BOX_CORNER_TL)
    writable.write(ansi.moveCursor(this.top, right))
    writable.write(unic.BOX_CORNER_TR)
    writable.write(ansi.moveCursor(this.bottom, left))
    writable.write(unic.BOX_CORNER_BL)
    writable.write(ansi.moveCursor(this.bottom, right))
